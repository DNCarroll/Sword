...
namespace Bastard.Bundler
{
    public partial class Form1 : Form
    {
        ...
        private void ButtonExecute_Click(object sender, EventArgs e)
        {
            ...
            if(!System.IO.Directory.Exists(@"C:\ProgramData\Bastard"))
            {
                System.IO.Directory.CreateDirectory(@"C:\ProgramData\Bastard");
            }
            string path = @"C:\ProgramData\Bastard\Bastard.ts";            
            ...
            try
            {
                ...
                {
                    System.Diagnostics.Process.Start(@"C:\Program Files (x86)\Microsoft SDKs\TypeScript\1.1", @"--declaration " + path);
                }
                else
                {
                    System.Diagnostics.Process.Start(@"C:\Program Files (x86)\Microsoft SDKs\TypeScript\1.1", @"--declaration " + path);                    
        ...
        private void ButtonRetrieve_Click(object sender, EventArgs e)
        {
            ...
            pathToRetrieve = pathToRetrieve.Substring(0, pathToRetrieve.IndexOf("Bundler")) + "Web";            
