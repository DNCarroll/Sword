...
module Data {    
    export var Views: Array<View.Info> = new Array<View.Info>();   
    export var ProjectID: number = 0;
    export var Projects: Array<any>;
    export var Connections: Array<any>;
    export function SelectedProject() :any {
        return Projects.First((o) => { return o.ProjectID == this.ProjectID; });
    }
    export var Items: Array<any>;    
