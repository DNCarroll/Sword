...
using Cearbhall.Sword_Extension;

namespace Sword.Extension_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new Sword_ExtensionPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Cearbhall.Sword_Extension.GuidList.guidSword_ExtensionCmdSet, (int)Cearbhall.Sword_Extension.PkgCmdIDList.cmdid10SwordContextCommand);
