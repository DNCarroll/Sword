...
namespace Sword.Extension_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Cearbhall.Sword_Extension.GuidList.guidSword_ExtensionCmdSet, (int)Cearbhall.Sword_Extension.PkgCmdIDList.cmdid10SwordContextCommand);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "Sword.Extension", "Cearbhall.Sword_Extension.Sword_ExtensionPackage");
